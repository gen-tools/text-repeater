          ...
          <ul className="grid gap-4 sm:grid-cols-2 text-foreground/90 leading-relaxed mb-8">
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm">
              ...
              <span className="text-sm">
                <Link href="/" className="text-primary hover:underline font-semibold">Text Repeater</Link> — repeat any text, word, or sentence up to 10,000 times.
              </span>
            </li>
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm">
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
            ...
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm">
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              <span className="text-sm">
                <Link href="/fancy-text-generator" className="text-primary hover:underline font-semibold">Fancy Text Generator</Link> — turn plain text into stylized fonts for bios and captions.
              </span>
            </li>
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm sm:col-span-2">
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              <span className="text-sm">
                <Link href="/case-converter" className="text-primary hover:underline font-semibold">Case Converter</Link> — switch text between uppercase, lowercase, and title case.
              </span>
            </li>
          </ul>
