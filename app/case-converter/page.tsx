          ...
          <ul className="grid gap-4 sm:grid-cols-2 text-foreground/90 leading-relaxed mb-8">
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm">
              ...
              <span className="text-sm">
                <Link href="/" className="text-primary hover:underline font-semibold">Text Repeater</Link> — repeats an entire word, sentence, or paragraph as many times as you need.
              </span>
            </li>
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm">
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              <span className="text-sm">
                <Link href="/word-repeater" className="text-primary hover:underline font-semibold">Word Repeater</Link> — repeats each individual word in your text on its own.
              </span>
            </li>
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm">
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              <span className="text-sm">
                <Link href="/emoji-repeater" className="text-primary hover:underline font-semibold">Emoji Repeater</Link> — multiplies emojis for captions and messages.
              </span>
            </li>
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm">
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              <span className="text-sm">
                <Link href="/blank-text" className="text-primary hover:underline font-semibold">Blank Text Generator</Link> — generates invisible Unicode characters for empty-looking text.
              </span>
            </li>
