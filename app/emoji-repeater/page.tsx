...
export const metadata: Metadata = {
  title: "Emoji Repeater Online | Repeat Emojis Instantly for Free",
  description: "Repeat emojis instantly with our free Emoji Repeater. Duplicate any emoji up to 10,000 times, customize separators, then copy or download in one click.",
  alternates: {
