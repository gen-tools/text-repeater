...
export const metadata: Metadata = {
  ...
  description: "Free Text Repeater to repeat text 100 times or up to 10,000. Duplicate words, sentences, emojis, messages, and chat instantly with custom separators.",
  alternates: {
      ...
      <section className="border-b border-border bg-gradient-to-b from-muted/50 to-background py-12 lg:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground text-pretty">
            This free online text repeater lets you repeat any text, word, emoji, or sentence as many times as you need — up to 10,000 — with instant copy and download. No signup, no install.
          </p>
        </div>
      </section>
      ...
      <section className="py-8 bg-muted/10 border-t border-border cv-auto">
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <div className="relative mx-auto w-full max-w-2xl aspect-[1376/768] overflow-hidden rounded-2xl border border-border bg-card shadow-lg transition-all duration-300 hover:shadow-xl">
            <Image
              src={heroImage}
              alt="Text Repeater online tool interface"
              fill
