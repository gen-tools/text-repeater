    ...
    <article className="w-full" id="word-repeater-page">
      ...
      <section className="py-16 border-t border-border bg-muted/30 cv-auto">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <ul className="grid gap-4 sm:grid-cols-2 text-foreground/90 leading-relaxed mb-8">
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm">
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              <span className="text-sm">
                <Link href="/" className="text-primary hover:underline font-semibold">Text Repeater</Link> — repeats your entire message, sentence, or paragraph as one block, rather than word by word.
              </span>
            </li>
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm">
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              <span className="text-sm">
                <Link href="/emoji-repeater" className="text-primary hover:underline font-semibold">Emoji Repeater</Link> — built specifically for multiplying emojis for captions and messages.
              </span>
            </li>
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm">
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              <span className="text-sm">
                <Link href="/blank-text" className="text-primary hover:underline font-semibold">Blank Text Generator</Link> — generates invisible characters and empty-looking text.
              </span>
            </li>
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm">
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              <span className="text-sm">
                <Link href="/fancy-text-generator" className="text-primary hover:underline font-semibold">Fancy Text Generator</Link> — turns plain text into stylized fonts for bios and captions.
              </span>
            </li>
            <li className="flex items-start gap-3 bg-card p-3.5 rounded-xl border border-border shadow-sm sm:col-span-2">
              <div className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-primary" />
              <span className="text-sm">
                <Link href="/case-converter" className="text-primary hover:underline font-semibold">Case Converter</Link> — switches text between uppercase, lowercase, and title case.
              </span>
            </li>
          </ul>
